...
--JOIN 2 TABLES
--HIGHEST AVERAGE RATING IN EACH CITY
--RIDE COMPLETED
--ATLEAST 5 RIDES
--LAST 3 MONTHS
...
(SELECT 
	...
	RANK()OVER(PARTITION BY D.CITY ORDER BY AVG(R.RATING) DESC) AS RNK
FROM RIDES R
JOIN DRIVERS D
ON R.DRIVER_ID=D.DRIVER_ID
WHERE R.END_TIME IS NOT NULL
AND R.START_TIME >= CURRENT_DATE - INTERVAL '3 MONTHS'
GROUP BY 1,2,3
HAVING COUNT(R.RIDE_ID)>=5) AS A
WHERE RNK = 1